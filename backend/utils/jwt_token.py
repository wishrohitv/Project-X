...
def decode_jwt_token(client_token, hash_key):
    """
    ...
    Args:
        ...
        hash_key (str): The hash key to use for decoding.

    Returns:
        dict: The decoded token payload.
    """
    data = jwt.decode(jwt=client_token, key=hash_key, algorithms="HS256")
    return data


def generate_jwt_token(user_data: dict[str, Any], hash_key: str, expire_in_minute: int):
